...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: dopecoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: dopecoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 40420 or testnet: 30420)") + "\n";
